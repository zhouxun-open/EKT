...
为了兼容大多数公链，EKT公链定义报文协议使用了HTTP协议作为基础，请求和响应的Content-Type必须为application/json，请求参数和响应参数必须与规定相同。详见<a href="./crosschain.md">跨链报文协议</a> 
<h4 id="cp3241">3.2.4.1跨链握手协议</h4>
    详见<a href="./crosschain.md">跨链报文协议</a>
